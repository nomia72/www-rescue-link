...
export const mockAdoptions: CaseItem[] = [
  {
    id: 'a1',
    title: '三花猫「花花」寻找领养',
    animalType: '猫',
    ...
    urgencyLevel: '一般',
    image: '',
    description: '约1岁母猫，已绝育已免疫，亲人粘人，适合有养猫经验的家庭。',
    contact: '微信：adopt_sh_001',
    helpType: 'adopt',
    heatValue: 42,
    initiatorDone: [],
    needs: [{ id: 'n1', name: '寻找领养', fulfilled: false, category: 'help' }],
    timeline: [],
    evidences: [],
  },
  {
    ...
    urgencyLevel: '一般',
    image: '',
    description: '约3岁公犬，中华田园犬，已绝育，温顺听话，适合有院子的家庭。',
    contact: '微信：adopt_sh_002',
    helpType: 'adopt',
    heatValue: 35,
    initiatorDone: [],
    needs: [{ id: 'n1', name: '寻找领养', fulfilled: false, category: 'help' }],
  ...
  },
  {
    ...
    urgencyLevel: '一般',
    image: '',
    description: '约6个月公猫，白色长毛蓝眼睛，活泼好动，需要耐心的主人。',
    contact: '微信：adopt_sh_003',
    helpType: 'adopt',
    heatValue: 28,
    initiatorDone: [],
    needs: [{ id: 'n1', name: '寻找领养', fulfilled: false, category: 'help' }],
